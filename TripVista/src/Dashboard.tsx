                                    ...
                                    <div className="table-responsive">
                                        <table className="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="./assets/images/face1.jpg" className="me-2" alt="image" /> David Grey
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="./assets/images/face2.jpg" className="me-2" alt="image" /> Stella Johnson
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="./assets/images/face3.jpg" className="me-2" alt="image" /> Marina Michel
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="./assets/images/face4.jpg" className="me-2" alt="image" /> John Doe
                                                    </td>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="d-flex mt-5 align-items-top">
                                        <img src="./assets/images/face3.jpg" className="img-sm rounded-circle me-3" alt="image" />
                                    ...
                                    <div className="list-wrapper">
                                        <ul className="d-flex flex-column-reverse todo-list todo-list-custom">
                                            ...
                                            <li className="completed">
                                                <div className="form-check">
                                                    <label className="form-check-label">
                                                        <input className="checkbox" type="checkbox" readOnly /> Call John </label>
                                                </div>
                                                <i className="remove mdi mdi-close-circle-outline"></i>
                                            </li>
                                            <li>
